...
<!--**********************************footer start ***********************************-->
  ...
  Crafted with ❤️ by Aman Gahlawat
    ...
    ***********************************-->
    ...
    <script>
        // Global auto-refresh on modal/offcanvas close (Bootstrap 5).
        // Keeps list pages in sync after add/edit actions.
        (function () {
            function safeReload() {
                try { window.location.reload(); } catch (e) {}
            }
            document.addEventListener('hidden.bs.modal', safeReload);
            document.addEventListener('hidden.bs.offcanvas', safeReload);
        })();
    </script>
