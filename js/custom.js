var W3Crm = function () {
	...
	var handleCkEditor = function () {
		...
		if (jQuery("#ckeditor_op4").length > 0) {
			ClassicEditor
				.create(document.querySelector('#ckeditor_op4'), {
					// toolbar: [ 'heading', '|', 'bold', 'italic', 'link' ]
					//plugins: [MathType],
					//toolbar: ['MathType', 'ChemType',]
				})
		...
		if (jQuery("#ckeditor_op3").length > 0) {
			ClassicEditor
				.create(document.querySelector('#ckeditor_op3'), {
					// toolbar: [ 'heading', '|', 'bold', 'italic', 'link' ]
					//plugins: [MathType],
					//toolbar: ['MathType', 'ChemType',]
				})
		...
		if (jQuery("#ckeditor_op2").length > 0) {
			ClassicEditor
				.create(document.querySelector('#ckeditor_op2'), {
					// toolbar: [ 'heading', '|', 'bold', 'italic', 'link' ]
					//plugins: [MathType],
					//toolbar: ['MathType', 'ChemType', ]
					...
					mathTypeParameters: {
						serviceProviderProperties: {
							URI: 'http://localhost/parassinghtech/examportal/js/ckeditor5/php-ckeditor5-8.6.0.1473/wiris/integration',
							server: 'php'
						}
					}
				})
		...
		if (jQuery("#ckeditor_op1").length > 0) {
			ClassicEditor
				.create(document.querySelector('#ckeditor_op1'), {
					// toolbar: [ 'heading', '|', 'bold', 'italic', 'link' ]
					//plugins: [MathType],
					//toolbar: ['MathType', 'ChemType', ]
				})
